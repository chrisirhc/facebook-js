    ...
    function convertTime(time) {
      return new Date(time).getTime();
		...
		var str = '+{+end_time:+' + eve.end_time +
							  '+,+location:+\'' + eve.location.replace(/ /gi, '+') +
								'\'+,+name:+\'' + eve.name.replace(/ /gi, '+') +
								'\'+,+start_time:+' + eve.start_time +
								'+,+description:+\'' + eve.description.replace(/ /gi, '+') +
								'\'+,+page_id:+\'' + eve.page_id +
...
module.exports = function (api_key, api_secret) {
  ...
  client.createEvent = function(token, param, callback) {
		console.log( facebook_api_url + '/method/events.create?event_info=' + escape(stringifyEvent(param))
